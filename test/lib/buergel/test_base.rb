...
describe Buergel do
  ...
  it "raise on unkonw lang code" do
    assert_raises(Buergel::BuergelException) {@buergel.set_lang('lt')}
  end

  it "contruct valid request xml" do
    answer = '<?xml version="1.0" encoding="iso-8859-1"?><BWIDATA><HEADER><SYSTEM_CODE>BAS</SYSTEM_CODE><KOMM_METHODE>TS</KOMM_METHODE><KOMM_TIMEOUT_SEKUNDEN>003</KOMM_TIMEOUT_SEKUNDEN><GP_ID>C55QN01</GP_ID><KNDNR>123</KNDNR><KNDFILIALE></KNDFILIALE><TRANSFNK>AN</TRANSFNK><USERID>321</USERID><SEGMENTNAME>C55QN01</SEGMENTNAME><FREMD_USERID></FREMD_USERID><DIALOGSPRACHE>01</DIALOGSPRACHE><XML_MARKUP_KZ>02</XML_MARKUP_KZ></HEADER><C55QN01><VERSANDART>6</VERSANDART><ANF_ART>70</ANF_ART><LIEFERSPRACHE>1</LIEFERSPRACHE><KND_KEY1></KND_KEY1><KND_KEY2></KND_KEY2><VORNAME>Hans</VORNAME><NAME1>Dampf</NAME1><STRASSE>Teststr.</STRASSE><HAUS_NR>12A</HAUS_NR><PLZ>12345</PLZ><ORT>Musterstadt</ORT><STAAT>276</STAAT></C55QN01></BWIDATA>'
    @buergel.construct_xml("Hans", "Dampf", "Teststr.", "12A", "12345", "Musterstadt", "de").must_equal(answer)
  end

  it "construct request xml with invlid country" do
